...
//TODO 1: Register pastCardsViewer and futureCardsViewer with deck as 
//PropertyChangeListeners,  i.e., observers of deck.
		deck.addPropertyChangeListener(pastCardsViewer);
		deck.addPropertyChangeListener(futureCardsViewer);
