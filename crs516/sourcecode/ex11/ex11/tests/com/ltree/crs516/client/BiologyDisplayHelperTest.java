 ...
 *
 */
public class BiologyDisplayHelperTest {

	private BiologyDisplayHelper testSubject;
	private Station station;

	@BeforeEach
	public void setUp() throws Exception {
		testSubject = new BiologyDisplayHelper();
	...
	public void testWithNoDataPresent() {
		station.setBiologyHeaders(new BiologyHeader[0]);
		String displayString = testSubject.mineStation(station);
