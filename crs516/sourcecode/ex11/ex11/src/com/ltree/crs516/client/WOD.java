...
public final class WOD extends JFrame implements WODClient{
	...
	/**
	 * This nested class generates the license information.
	 */
	private final class AboutDialog extends JDialog {
		...
		public AboutDialog() {
			...
			area.setText("\n ===========================================================\n" +
							...
							"\n ===========================================================" +
							" \n" +
							" \n (C) Copyright 2017, by Crs516 development team" +
							" \n" +
	 ...
	 */
	ActionListener stationFieldListener = event ->{
	...
	public WOD(String title) {
		...
		stationField.addActionListener(stationFieldListener);
		...
		prevButton.addActionListener(event -> controller.previous());
	 ...
	 * loads a new station. 
	 */
	public void setLocators(final int currentStation, final int dbSize){
