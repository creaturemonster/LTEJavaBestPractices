...
public final class StationParser {
	...
	synchronized Station makeStation(String stationString) throws IOException {
		 ...
		 * stationString. The build() method will produce the Station object.
		 */
	...
	private Station.StationBuilder readBasicInformation(String stationString) throws IOException {
		/*
		 * We scan stationString character by character. The WOD documentation instructs how to 
		 * interpret each one. For the reader, just note that by the bottom of this method the
		 * mandatory data that has to be present in all stations has been read and used to create
		 * the builder.
		 */
		char currentChar;
		...
		/*
		 * Use the mandatory data to create and return the builder.
		 */
	...
	/**
	 * Read any optional variables into the builder.
	 * @param builder a StationBuilder
	 * @return the builder
	 */
	private Station.StationBuilder readVariables(Station.StationBuilder builder) {
		/*
		 * For the reader, this method reads characters from the station string and
		 * interprets them using code tables from NOAA and inserts the information in
		 * the builder.
		 */
		int number;
		int numVar;
	...
	/**
	 * Some readings like temperature and pressure readings are in the form 
	 * of profiles, i.e. readings at different levels (depths) of the ocean. This method
	 * inserts such data into the builder.
	 * @param builder
	 * @return
	 */
	...
	/**
	 * Biology headers are for biological data like chlorophyl levels etc
	 * @param builder
	 * @return
	 */
	...
	/**
	 * Taxonomic data will have details on how biological data was measured.
	 * @param builder
	 * @return
	 */
