...
public class Driver {
	...
	public static void main(String[] args) {
		...
		controller.addPropertyChangeListener(primaryHeaderTab);
		controller.addPropertyChangeListener(characterDataTab);
		controller.addPropertyChangeListener(secondaryHeaderTab);
		controller.addPropertyChangeListener(biologyHeaderTab);
		controller.addPropertyChangeListener(taxaTab);
		controller.addPropertyChangeListener(profileDataTab);
