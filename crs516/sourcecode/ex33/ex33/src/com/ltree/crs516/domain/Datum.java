...
//Perform the TODO tasks in Builder.
	...
	public static class Builder{
		...
		//Make them private and final and don't give them starting values.
		//Since they are final this means they have to be set in 
		//the constructor.
		...
		//Since they are optional give them default values.
...
//TODO 4: Note: The four non-mandatory parameters meaning, originatorsFlag, 
//qualityFlag, qualityFlagString will optionally be supplied 
//using methods like the one below. It returns a reference to the Builder to 
//allow chaining.
...
//TODO 5: In the build() create a Datum by calling the constructor of 
