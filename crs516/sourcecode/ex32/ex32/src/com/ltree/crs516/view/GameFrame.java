...
public final class GameFrame extends JFrame implements PropertyChangeListener {
	...
	public GameFrame(final TehiGame game) {
		setTitle("Tehi");
		this.game = game;
		...
		loadItem.addActionListener(	event -> {
			try {
				...
				JOptionPane.showMessageDialog(GameFrame.this, "There is no saved game");
			}
		});
	...
	private JPanel createLeftPanel() {
		...
		game.getDeck().addPropertyChangeListener(historyChart);
