...
public final class CardsChart extends JPanel implements PropertyChangeListener {
	...
	public static void main(String[] args) {
		...
		chart.propertyChange(new PropertyChangeEvent(chart,null,null,new int[] { 1, 2, 3, 4, 3, 2, 1, 2, 3, 4, 3, 2, 1 }));
	}

	@Override
	public void propertyChange(PropertyChangeEvent evt) {
		int[] ranksDealt = (int[]) evt.getNewValue();
		updateTiles(ranksDealt);
	}
}
